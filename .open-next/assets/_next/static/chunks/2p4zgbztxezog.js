(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,29306,e=>{"use strict";var t=e.i(43476),n=e.i(22016),a=e.i(2971),r=e.i(71645);let o=[{text:"> MASKEDHELP_OS v2.0 — BOOTING...",delay:0},{text:"> CHECKING ROUTES...",delay:300},{text:"> ERROR 404 — ROUTE NOT MAPPED",color:"#e63329",delay:600},{text:'> TYPE "help" FOR AVAILABLE COMMANDS',color:"#ffb400",delay:900}],i={help:()=>["  AVAILABLE COMMANDS:","  ─────────────────────────────────────","  home          → go to homepage","  projects      → view all projects","  skills        → skill matrix","  experience    → work history","  team          → meet the team","  resume        → download CV","  whoami        → who is maskedhelp","  clear         → clear terminal","  ls            → list all pages","  ping          → check if site is alive","  hack          → ...","  sudo          → try it","  exit          → close terminal (joke)"],home:()=>(window.location.href="/","> REDIRECTING TO HOME..."),projects:()=>(window.location.href="/projects","> REDIRECTING TO PROJECTS..."),skills:()=>(window.location.href="/skills","> REDIRECTING TO SKILLS..."),experience:()=>(window.location.href="/experience","> REDIRECTING TO EXPERIENCE..."),team:()=>(window.location.href="/team","> REDIRECTING TO TEAM..."),resume:()=>(window.location.href="/resume","> REDIRECTING TO RESUME..."),ls:()=>["  drwxr  /home","  drwxr  /projects","  drwxr  /skills","  drwxr  /experience","  drwxr  /team","  drwxr  /resume","  drwxr  /friends","  -rw-r  /privacy","  -rw-r  /terms","  ??     /404  ← you are here"],whoami:()=>["  KARTHIK KUMAR // MASKEDHELP","  ─────────────────────────────────────","  ROLE      : FULL STACK DEV · AI · ROBOTICS","  LOCATION  : AMITY UNIVERSITY, INDIA","  STACK     : RUST · REACT · ROS2 · QMK","  STATUS    : BUILDING THINGS THAT SHOULDNT EXIST","  GITHUB    : github.com/Maskedhelp2"],ping:()=>["  PINGING MASKEDHELP.COM...","  64 bytes from maskedhelp.com: icmp_seq=1 ttl=64 time=0.4ms","  64 bytes from maskedhelp.com: icmp_seq=2 ttl=64 time=0.3ms","  64 bytes from maskedhelp.com: icmp_seq=3 ttl=64 time=0.3ms","  ─────────────────────────────────────","  SITE IS ALIVE. YOU ARE JUST LOST."],hack:()=>["  INITIATING HACK SEQUENCE...","  [████████████████████░░░░] 80%","  ...","  ACCESS DENIED.","  (nice try)"],sudo:()=>["  sudo: you are not in the sudoers file.","  This incident will be reported.","  (it wont)"],exit:()=>["  this is a webpage.","  you cannot exit.","  close the tab if you must."],clear:()=>"__CLEAR__"};e.s(["default",0,function(){let[e,l]=(0,r.useState)([]),[s,c]=(0,r.useState)(""),[p,d]=(0,r.useState)(!1),[f,x]=(0,r.useState)([]),[m,h]=(0,r.useState)(-1),u=(0,r.useRef)(null),b=(0,r.useRef)(null);return(0,r.useEffect)(()=>{let e=[];return o.forEach(({text:t,color:n,delay:a})=>{e.push(setTimeout(()=>{l(e=>[...e,{text:t,color:n}]),900===a&&setTimeout(()=>d(!0),300)},a))}),()=>e.forEach(clearTimeout)},[]),(0,r.useEffect)(()=>{b.current?.scrollIntoView({behavior:"smooth"})},[e]),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:`
      ...
      `}),(0,t.jsx)(a.default,{}),(0,t.jsxs)("main",{className:"nf-wrap",onClick:function(){u.current?.focus()},children:[(0,t.jsx)("div",{className:"nf-code",children:"404"}),(0,t.jsxs)("div",{className:"nf-terminal",children:[(0,t.jsxs)("div",{className:"nf-title-bar",children:[(0,t.jsx)("div",{className:"nf-dot",style:{background:"#e63329"}}),(0,t.jsx)("div",{className:"nf-dot",style:{background:"#ffb400"}}),(0,t.jsx)("div",{className:"nf-dot",style:{background:"#00d2d2"}}),(0,t.jsx)("span",{className:"nf-title-text",children:"MASKEDHELP_OS — 404.sh"})]}),(0,t.jsxs)("div",{className:"nf-output",children:[e.map((e,n)=>(0,t.jsx)("div",{className:"nf-out-line",style:{color:e.color??(e.isInput?"#00d2d2":"#555")},children:e.text},n)),(0,t.jsx)("div",{ref:b})]}),p&&(0,t.jsxs)("div",{className:"nf-input-row",children:[(0,t.jsx)("span",{className:"nf-prompt",children:"$"}),(0,t.jsx)("input",{ref:u,className:"nf-input",value:s,onChange:e=>c(e.target.value),onKeyDown:function(e){if("Enter"===e.key)!function(e){let t=e.trim().toLowerCase();if(!t)return;if(x(e=>[t,...e].slice(0,20)),h(-1),l(t=>[...t,{text:"$ "+e,color:"#00d2d2",isInput:!0}]),"clear"===t)return l([]);let n=i[t];if(!n)return l(e=>[...e,{text:"  command not found: "+t,color:"#e63329"},{text:'  type "help" for available commands',color:"#444"}]);let a=n();"__CLEAR__"===a?l([]):"string"==typeof a?l(e=>[...e,{text:a}]):l(e=>[...e,...a.map(e=>({text:e}))])}(s),c("");else if("ArrowUp"===e.key){e.preventDefault();let t=Math.min(m+1,f.length-1);h(t),c(f[t]??"")}else if("ArrowDown"===e.key){e.preventDefault();let t=Math.max(m-1,-1);h(t),c(-1===t?"":f[t]??"")}else if("Tab"===e.key){e.preventDefault();let t=Object.keys(i).find(e=>e.startsWith(s.toLowerCase()));t&&c(t)}},placeholder:"type a command...",autoFocus:!0,autoComplete:"off",autoCorrect:"off",autoCapitalize:"off",spellCheck:!1})]}),(0,t.jsx)("div",{className:"nf-hint",children:'TAB autocomplete · ↑↓ history · "help" to start'})]}),(0,t.jsxs)("div",{className:"nf-nav",children:[(0,t.jsx)(n.default,{href:"/",className:"nf-nav-btn",children:"HOME"}),(0,t.jsx)(n.default,{href:"/projects",className:"nf-nav-btn",children:"PROJECTS"}),(0,t.jsx)(n.default,{href:"/skills",className:"nf-nav-btn",children:"SKILLS"}),(0,t.jsx)(n.default,{href:"/experience",className:"nf-nav-btn",children:"EXPERIENCE"})]})]})]})}])}]);